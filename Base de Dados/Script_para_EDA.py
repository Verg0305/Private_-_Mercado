...
caminho_fundos_private = "Dados Fundos Private.xlsx"
...
caminho_dados_geograficos_private = "Dados Geográficos Private.xlsx"
...
caminho_fundos_mercado = "Dados Indústria Fundos Brasil.xlsx"
...
Historico_Dolar = pd.read_excel("Histórico Dólar.xlsx")

## Baixando Base de Dados Ibovespa
Historico_Ibovespa = pd.read_excel("Histórico Ibovespa.xlsx")

## Baixando Base de Dados Selic
Historico_Selic = pd.read_excel("Histórico Selic.xlsx")
